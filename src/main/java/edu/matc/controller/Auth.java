...
public class Auth extends HttpServlet implements PropertiesLoader {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (authCode == null) {
            logger.error("Missing Cognito authorization code.");
            ...
            try {
                ...
                if (users.isEmpty()) {
                    logger.info("No existing user found for Cognito username. Creating new user.");
                    user = new User();
                    user.setUsername(userName);
                    user.setEmail(userName + "@example.com"); // or extract real email from token
    ...
    private String validate(TokenResponse tokenResponse) throws IOException {
        ...
        logger.debug("here's the username: " + cognitoUserName);
